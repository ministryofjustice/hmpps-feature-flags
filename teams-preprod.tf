# Teams allowed to access namespaces in the preprod environment
# Format: namespace_name = ["github-team-1", "github-team-2"]

allowed_teams = {
  # Probation in Court team
  ProbationInCourt = ["hmpps-probation-in-court"]

  # Manage a Workforce
  ManageAWorkforce = ["manage-a-workforce"]

  # Community Accommodation (note: typo in namespace name kept for compatibility)
